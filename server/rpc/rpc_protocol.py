...
def make_error(message: str, id: Optional[str] = None, code: int = -32000, data: Any = None) -> JSONRPCErrorResponse:
    return JSONRPCErrorResponse(error=JSONRPCError(code=code, message=message, data=data), id=id)
